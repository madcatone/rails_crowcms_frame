...
User.create(email: 'admin@163.com', password: 'admin1234')
...
# 
# 
Admin::Menu.create(name: '企业介绍', url: '/about-us')
Admin::Menu.create(name: '企业新闻', url: '/news')
Admin::Menu.create(name: '企业公告', url: '/notices')
Admin::Menu.create(name: '企业产品', url: '/products')
Admin::Menu.create(name: '联系我们', url: '/contract-us')
